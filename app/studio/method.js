...
export async function mountMethod(root){
 ...
 root.innerHTML=`<div class="method-actions"><a class="btn" href="#/today">${icon('back')} План дня</a><a class="btn" href="#/mastery">Результаты A1–C2</a><a class="btn" href="#/projects">Проект недели</a><a class="btn" href="#/transfer">Применить изученное</a><a class="btn" href="#/notebook">Мои мысли</a></div><details class="method-contents"><summary>Перейти к разделу</summary><nav aria-label="Разделы руководства"></nav></details><article class="learning-method">${html}</article>`;
