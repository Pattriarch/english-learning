...
const scenes={
 states:{file:'be-states-scene.png',alt:'Слева девушка с ключами и рюкзаком готова выйти; справа она устало зевает на диване.',title:'В русском без глагола, в английском — с am',en:'I am ready. I am tired.',ru:'Я готова. Я устала.',why:'Вот что девушка может сказать о себе. I — «я», ready — «готова», tired — «устала». Am связывает человека и его состояние. Даже если по-русски отдельного слова нет, по-английски am нужно.'},
