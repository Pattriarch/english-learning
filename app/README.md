...
Подробные словарные разборы публикуются по мере отдельной проверки: точный объём и признак полного выпуска находятся в `content/lexicon/full-analysis.json` и показаны в словаре. Дополнительные 59 глав из новых книг проходят отдельную подготовку и проверку; разбор исходных страниц сам по себе не означает готовность урока.
